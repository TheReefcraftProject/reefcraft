...
class ComputeLBM:
    ...
    def update_mesh(self, state: SimState) -> None:
        ...
        self.setup_boundary_conditions()  # Update boundary conditions after mesh update
    ...
    def setup_boundary_conditions(self) -> None:
        ...
        self.stepper.boundary_conditions = self.boundary_conditions  # Update stepper with new boundary conditions
